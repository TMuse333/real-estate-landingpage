    ...
    <div className='header-container'>
      ...
      <div className='list-container'>
        ...
        <ul style={style} className='nav-list'>
          ...
          <li onClick={()=>scrollToSection('skills')}>Documents</li>

          <li onClick={()=>scrollToSection('skills')}>Map</li>

          <li onClick={()=>scrollToSection('skills')}>Broker</li>

          <li onClick={()=>scrollToSection('skills')}>Request info</li>

          <li onClick={()=>scrollToSection('skills')}>share</li>

          <li onClick={()=>scrollToSection('skills')}>More listings</li>

          <li onClick={()=>scrollToSection('skills')}>Book showing</li>
